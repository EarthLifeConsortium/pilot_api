...
our (@EXPORT_OK) = qw(connectDB loadConfig configData loadSQLFile activateTables sql_do);
...
# sql_do ( dbh, sql, options )
# 
# Execute the specified SQL command, and print out a debugging message if
# specified by the options.

sub sql_do {
    
    my ($dbh, $sql, $options) = @_;
